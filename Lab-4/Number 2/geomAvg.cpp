...
#include <iostream>
#include <cmath>
double filterThreshold(const int arr[], const int size, const int threshold){
    int count = 0;
    double product = 0;
    double result = 0;
    ...
    result = std::pow(product, 1/count);
...
void geomAvg(){
    ...
    double result1 = filterThreshold(arr1, size, threshold);
    double result2 = filterThreshold(arr2, size, threshold);
    double result3 = filterThreshold(arr3, size, threshold);
